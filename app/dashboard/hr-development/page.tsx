  ...
  return (
    <DashboardLayout>
      <div className="space-y-8">
        <div>
          <h1 className="text-3xl font-bold text-foreground">HR Pengembangan Dashboard</h1>
          <p className="text-muted-foreground mt-1">Kelola pekerjaan, kompetensi, dan pengembangan talenta</p>
        </div>
        ...
        <Card className="p-6">
          <h2 className="text-xl font-bold text-foreground mb-4">Pengembangan Talenta</h2>
